    ...
    parse: function(input, startRule) {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, program) {
                return program;
              })(r1.offset, r1.line, r1.column, r6);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_FiMlogStatement() {
        ...
        if (r3 !== null) {
          r4 = parse___();
          if (r4 !== null) {
            if (input.substr(pos.offset, 4) === "said") {
              r5 = "said";
              advance(pos, 4);
            } else {
              r5 = null;
      ...
      function parse_FiMassignStatement() {
        ...
        if (r5 !== null) {
          r6 = parse___();
          if (r6 !== null) {
            if (input.substr(pos.offset, 7) === "learned") {
              r7 = "learned";
              advance(pos, 7);
            } else {
              r7 = null;
        ...
        if (r3 === null) {
          r4 = clone(pos);
          if (input.substr(pos.offset, 3) === "Did") {
            r5 = "Did";
            advance(pos, 3);
          } else {
            r5 = null;
          ...
          if (r5 !== null) {
            ...
            if (r6 !== null) {
              ...
              if (r7 !== null) {
                r8 = parse___();
                if (r8 !== null) {
                  if (input.substr(pos.offset, 4) === "know") {
                    r9 = "know";
                    advance(pos, 4);
                  } else {
                    r9 = null;
      ...
      function parse_FiMactor() {
        ...
        if (r0 === null) {
          if (input.substr(pos.offset, 3) === "you") {
            r0 = "you";
            advance(pos, 3);
          } else {
            r0 = null;
      ...
      function parse_FiMthat() {
        ...
        if (input.substr(pos.offset, 4) === "that") {
          r0 = "that";
          advance(pos, 4);
        } else {
          r0 = null;
      ...
      function parse_FiMassign() {
        ...
        if (input.substr(pos.offset, 3) === "was") {
          r0 = "was";
          advance(pos, 3);
        } else {
          r0 = null;
      ...
      function parse_FiMsalutation() {
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 4) === "Dear") {
          r2 = "Dear";
          advance(pos, 4);
        } else {
          r2 = null;
      ...
      function parse_FiMvalediction() {
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 21) === "Your faithful student") {
          r2 = "Your faithful student";
          advance(pos, 21);
        } else {
          r2 = null;
          if (reportFailures === 0) {
