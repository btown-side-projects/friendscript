  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ZWNJ": parse_ZWNJ,
        "ZWJ": parse_ZWJ,
        "FiMprogram": parse_FiMprogram,
        "FiMblock": parse_FiMblock,
        "FiMstatement": parse_FiMstatement,
        "FiMlogStatement": parse_FiMlogStatement,
        "FiMassignStatement": parse_FiMassignStatement,
        "FiMdefinition": parse_FiMdefinition,
        "FiMargumentDeclaration": parse_FiMargumentDeclaration,
        "FiMreturnStatement": parse_FiMreturnStatement,
        "FiMinvocation": parse_FiMinvocation,
        "FiMinvocationSpecifier": parse_FiMinvocationSpecifier,
        "FiMarguments": parse_FiMarguments,
        "FiMprimaryExpression": parse_FiMprimaryExpression,
        "FiMidentifier": parse_FiMidentifier,
        "FiMidentifierString": parse_FiMidentifierString,
        "FiMidentifierWord": parse_FiMidentifierWord,
        "FiMidentifierWordSep": parse_FiMidentifierWordSep,
        "FiMfactPrefix": parse_FiMfactPrefix,
        "FiMnull": parse_FiMnull,
        "FiMreserved": parse_FiMreserved,
        "FiMactor": parse_FiMactor,
        "FiMthat": parse_FiMthat,
        "FiMassign": parse_FiMassign,
        "FiMto": parse_FiMto,
        "FiMhow": parse_FiMhow,
        "FiMdid": parse_FiMdid,
        "FiMknow": parse_FiMknow,
        "FiMlearned": parse_FiMlearned,
        "FiMtoday": parse_FiMtoday,
        "FiMwould": parse_FiMwould,
        "FiMtold": parse_FiMtold,
        "FiMasked": parse_FiMasked,
        "FiMsaid": parse_FiMsaid,
        "FiMthen": parse_FiMthen,
        "FiMgot": parse_FiMgot,
        "FiMsalutation": parse_FiMsalutation,
        "FiMvalediction": parse_FiMvalediction,
        "FiMcolon": parse_FiMcolon,
        "FiMstatementEnd": parse_FiMstatementEnd,
        "FiMprogramQuotes": parse_FiMprogramQuotes,
        "FiMpossessive": parse_FiMpossessive,
        "FiMstartArgs": parse_FiMstartArgs,
        "FiMsepArgs": parse_FiMsepArgs
      };
      ...
      function parse_compoundAssignmentOp() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, left, ws0, op, ws1, right) {
              ...
              })(r1.offset, r1.line, r1.column, r3, r4, r5, r7, r8);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_callExpression() {
        ...
        if (r3 !== null) {
          ...
          if (r4 !== null) {
            r5 = parse_secondaryArgumentList();
            r5 = r5 !== null ? r5 : "";
            if (r5 !== null) {
              r0 = [r3, r4, r5];
            } else {
      ...
      function parse_finallyClause() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws, body) {
              return {block: body.block, raw: ws + 'finally' + body.raw};
            })(r1.offset, r1.line, r1.column, r3, r5);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMprogram() {
        var cacheKey = "FiMprogram@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        r2 = clone(pos);
        r3 = parse_FiMsalutation();
        if (r3 !== null) {
          r4 = parse__();
          if (r4 !== null) {
            r5 = parse_FiMidentifier();
            if (r5 !== null) {
              r6 = parse__();
              if (r6 !== null) {
                r7 = parse_FiMcolon();
                    ...
                    if (r9 !== null) {
                      ...
                      if (r10 !== null) {
                        ...
                        if (r11 !== null) {
                          r12 = parse__();
                          if (r12 !== null) {
                            r13 = parse_FiMvalediction();
                            if (r13 !== null) {
                              r14 = parse__();
                              if (r14 !== null) {
                                r15 = parse_TERMINATOR();
                                r15 = r15 !== null ? r15 : "";
                                if (r15 !== null) {
                                  r16 = parse__();
                                  if (r16 !== null) {
                                    r17 = parse_FiMidentifier();
                                    if (r17 !== null) {
                                      r18 = parse_FiMstatementEnd();
                                      r18 = r18 !== null ? r18 : "";
                                      if (r18 !== null) {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, addressee, block, writer) {
              ...
              */
              ...
              return wrapper;
            })(r1.offset, r1.line, r1.column, r5, r11, r17);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, program) {
                return program;
              })(r1.offset, r1.line, r1.column, r7);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_FiMblock() {
        var cacheKey = "FiMblock@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMstatement() {
        var cacheKey = "FiMstatement@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r0 = parse_FiMlogStatement();
        if (r0 === null) {
          r0 = parse_FiMinvocation();
          if (r0 === null) {
            r0 = parse_FiMassignStatement();
            if (r0 === null) {
              r0 = parse_FiMdefinition();
              if (r0 === null) {
                r0 = parse_FiMreturnStatement();
              }
            }
          }
        }
      ...
      function parse_FiMlogStatement() {
        var cacheKey = "FiMlogStatement@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (r3 !== null) {
          ...
          if (r4 !== null) {
            ...
            if (r5 !== null) {
              r6 = parse___();
              if (r6 !== null) {
                r7 = parse_FiMprimaryExpression();
                if (r7 !== null) {
                  r8 = parse_FiMstatementEnd();
                  if (r8 !== null) {
                    r0 = [r3, r4, r5, r6, r7, r8];
                  } else {
                    r0 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, expression) {
      ...
      function parse_FiMassignStatement() {
        var cacheKey = "FiMassignStatement@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
                ...
                if (r7 !== null) {
                  ...
                  if (r8 !== null) {
                    ...
                    if (r9 !== null) {
                      r10 = parse___();
                      if (r10 !== null) {
                        r11 = parse_FiMprimaryExpression();
                        if (r11 !== null) {
                          r12 = parse_FiMstatementEnd();
                          if (r12 !== null) {
                            r0 = [r3, r4, r5, r6, r7, r8, r9, r10, r11, r12];
                          } else {
                            r0 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, target, source) {
              // console.error(target, source);
              return new CS.AssignOp(target, source);
            })(r1.offset, r1.line, r1.column, r7, r11);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMdefinition() {
        var cacheKey = "FiMdefinition@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        var r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24;
                ...
                if (r7 !== null) {
                  ...
                  if (r8 !== null) {
                    ...
                    if (r9 !== null) {
                      ...
                      r13 = parse___();
                      if (r13 !== null) {
                        r14 = parse_FiMargumentDeclaration();
                        if (r14 !== null) {
                          r10 = [r13, r14];
                        } else {
                          r10 = null;
                      ...
                      if (r10 !== null) {
                        r10 = (function(offset, line, column, a) {return a;})(r11.offset, r11.line, r11.column, r14);
                      }
                      if (r10 === null) {
                        pos = clone(r11);
                      }
                                        ...
                                        if (r19 !== null) {
                                          ...
                                          if (r20 !== null) {
                                            ...
                                            if (r21 !== null) {
                                              r22 = parse___();
                                              if (r22 !== null) {
                                                r23 = parse_FiMidentifierString();
                                                if (r23 !== null) {
                                                  r24 = parse_FiMstatementEnd();
                                                  if (r24 !== null) {
                                                    r0 = [r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24];
                                                  } else {
                                                    r0 = null;
                                                    pos = clone(r2);
                                                  }
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, prefix, verb, args, block, verb2) {
              ...
              return assign;
            })(r1.offset, r1.line, r1.column, r3, r8, r10, r16, r23);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMargumentDeclaration() {
        var cacheKey = "FiMargumentDeclaration@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        r2 = clone(pos);
        r3 = parse_FiMstartArgs();
        if (r3 !== null) {
          r4 = parse___();
          if (r4 !== null) {
            r5 = parse_FiMidentifierString();
            if (r5 !== null) {
              r6 = [];
              r8 = clone(pos);
              r9 = parse__();
              if (r9 !== null) {
                r10 = parse_FiMsepArgs();
                if (r10 !== null) {
                  r11 = parse__();
                  if (r11 !== null) {
                    r12 = parse_FiMidentifierString();
                    if (r12 !== null) {
                      r7 = [r9, r10, r11, r12];
                    } else {
                      r7 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, first, rest) {
              var args = [first];
              if (rest) {
            ...
            })(r1.offset, r1.line, r1.column, r5, r6);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMreturnStatement() {
        var cacheKey = "FiMreturnStatement@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
            ...
            if (r5 !== null) {
              ...
              if (r6 !== null) {
                ...
                if (r7 !== null) {
                  r8 = parse___();
                  if (r8 !== null) {
                    r9 = parse_FiMprimaryExpression();
                    if (r9 !== null) {
                      r10 = parse_FiMstatementEnd();
                      if (r10 !== null) {
                        r0 = [r3, r4, r5, r6, r7, r8, r9, r10];
                      } else {
                        r0 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, e) {
            ...
            })(r1.offset, r1.line, r1.column, r9);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMinvocation() {
        var cacheKey = "FiMinvocation@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
            ...
            if (r5 !== null) {
              ...
              if (r6 !== null) {
                ...
                if (r7 !== null) {
                  r8 = parse___();
                  if (r8 !== null) {
                    r9 = parse_FiMinvocationSpecifier();
                    if (r9 !== null) {
                      r11 = clone(pos);
                      r12 = clone(pos);
                      r13 = parse___();
                      if (r13 !== null) {
                        r14 = parse_FiMarguments();
                        if (r14 !== null) {
                          r10 = [r13, r14];
                        } else {
                          r10 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, target, specifier, args) {
              var app = new CS.FunctionApplication(specifier, args);
              return new CS.AssignOp(target, app);
            })(r1.offset, r1.line, r1.column, r7, r9, r10);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r3 !== null) {
            r4 = parse___();
            if (r4 !== null) {
              r5 = parse_FiMinvocationSpecifier();
              if (r5 !== null) {
                r7 = clone(pos);
                r8 = clone(pos);
                r9 = parse___();
                if (r9 !== null) {
                  r10 = parse_FiMarguments();
                  if (r10 !== null) {
                    r6 = [r9, r10];
                  } else {
                    r6 = null;
                ...
                if (r6 !== null) {
                  r6 = (function(offset, line, column, a) {return a;})(r7.offset, r7.line, r7.column, r10);
                }
                if (r6 === null) {
                  pos = clone(r7);
                }
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, specifier, args) {
      ...
      function parse_FiMinvocationSpecifier() {
        var cacheKey = "FiMinvocationSpecifier@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, parent, method) {
              return new CS.MemberAccessOp(parent, method);
            })(r1.offset, r1.line, r1.column, r5, r9);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, verb) {
                return verb;
              })(r1.offset, r1.line, r1.column, r5);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_FiMarguments() {
        var cacheKey = "FiMarguments@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
            ...
            if (r5 !== null) {
              ...
              if (r9 !== null) {
                ...
                if (r10 !== null) {
                  r11 = parse__();
                  if (r11 !== null) {
                    r12 = parse_FiMprimaryExpression();
                    if (r12 !== null) {
                      r7 = [r9, r10, r11, r12];
                    } else {
                      r7 = null;
      ...
      function parse_FiMprimaryExpression() {
        var cacheKey = "FiMprimaryExpression@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMidentifier() {
        var cacheKey = "FiMidentifier@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        r2 = clone(pos);
        r3 = parse_FiMidentifierString();
        if (r3 !== null) {
          r4 = parse_FiMpossessive();
          if (r4 !== null) {
            r5 = parse_FiMidentifierWordSep();
            if (r5 !== null) {
              r6 = parse_FiMidentifierString();
              if (r6 !== null) {
                r0 = [r3, r4, r5, r6];
              } else {
                r0 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, id, poss, property) {
              // console.error(id);
              // console.error(poss);
        ...
        if (r0 === null) {
          r1 = clone(pos);
          r0 = parse_FiMidentifierString();
          if (r0 !== null) {
            r0 = (function(offset, line, column, string) {
      ...
      function parse_FiMidentifierString() {
        var cacheKey = "FiMidentifierString@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        r2 = clone(pos);
        r3 = parse_FiMidentifierWord();
        if (r3 !== null) {
          r4 = [];
          r6 = clone(pos);
          r7 = parse_FiMidentifierWordSep();
          if (r7 !== null) {
            r8 = parse_FiMidentifierWord();
            if (r8 !== null) {
              r5 = [r7, r8];
            } else {
              r5 = null;
      ...
      function parse_FiMidentifierWord() {
        var cacheKey = "FiMidentifierWord@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, n) { return n; })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMidentifierWordSep() {
        var cacheKey = "FiMidentifierWordSep@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMfactPrefix() {
        var cacheKey = "FiMfactPrefix@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMnull() {
        var cacheKey = "FiMnull@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 7).toLowerCase() === "nothing") {
          r0 = input.substr(pos.offset, 7);
          advance(pos, 7);
        } else {
          r0 = null;
          if (reportFailures === 0) {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return new CS.Null(); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMreserved() {
        var cacheKey = "FiMreserved@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r0 = parse_FiMsalutation();
        if (r0 === null) {
          r0 = parse_FiMvalediction();
          if (r0 === null) {
            r0 = parse_FiMcolon();
            if (r0 === null) {
              r0 = parse_FiMactor();
              if (r0 === null) {
                r0 = parse_FiMstatementEnd();
                if (r0 === null) {
                  r0 = parse_FiMthat();
                  if (r0 === null) {
                    r0 = parse_FiMassign();
                    if (r0 === null) {
                      r0 = parse_FiMprogramQuotes();
                      if (r0 === null) {
                        r0 = parse_FiMpossessive();
                        if (r0 === null) {
                          r0 = parse_FiMto();
                          if (r0 === null) {
                            r0 = parse_FiMhow();
      ...
      function parse_FiMactor() {
        var cacheKey = "FiMactor@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.charCodeAt(pos.offset) === 73) {
          r0 = "I";
          advance(pos, 1);
        } else {
          r0 = null;
        ...
        if (r0 === null) {
          if (input.substr(pos.offset, 3).toLowerCase() === "you") {
            r0 = input.substr(pos.offset, 3);
            advance(pos, 3);
          } else {
            r0 = null;
            if (reportFailures === 0) {
      ...
      function parse_FiMthat() {
        var cacheKey = "FiMthat@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 4).toLowerCase() === "that") {
          r0 = input.substr(pos.offset, 4);
          advance(pos, 4);
        } else {
          r0 = null;
          if (reportFailures === 0) {
      ...
      function parse_FiMassign() {
        var cacheKey = "FiMassign@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 3).toLowerCase() === "was") {
          r0 = input.substr(pos.offset, 3);
          advance(pos, 3);
        } else {
          r0 = null;
      ...
      function parse_FiMto() {
        var cacheKey = "FiMto@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 2).toLowerCase() === "to") {
          r0 = input.substr(pos.offset, 2);
          advance(pos, 2);
        } else {
          r0 = null;
          if (reportFailures === 0) {
      ...
      function parse_FiMhow() {
        var cacheKey = "FiMhow@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 3).toLowerCase() === "how") {
          r0 = input.substr(pos.offset, 3);
          advance(pos, 3);
        } else {
          r0 = null;
      ...
      function parse_FiMdid() {
        var cacheKey = "FiMdid@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 3).toLowerCase() === "did") {
          r0 = input.substr(pos.offset, 3);
          advance(pos, 3);
        } else {
          r0 = null;
      ...
      function parse_FiMknow() {
        var cacheKey = "FiMknow@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 4).toLowerCase() === "know") {
          r0 = input.substr(pos.offset, 4);
          advance(pos, 4);
        } else {
          r0 = null;
      ...
      function parse_FiMlearned() {
        var cacheKey = "FiMlearned@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 7).toLowerCase() === "learned") {
          r0 = input.substr(pos.offset, 7);
          advance(pos, 7);
        } else {
          r0 = null;
      ...
      function parse_FiMtoday() {
        var cacheKey = "FiMtoday@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 5).toLowerCase() === "today") {
          r0 = input.substr(pos.offset, 5);
          advance(pos, 5);
        } else {
          r0 = null;
          if (reportFailures === 0) {
      ...
      function parse_FiMwould() {
        var cacheKey = "FiMwould@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 5).toLowerCase() === "would") {
          r0 = input.substr(pos.offset, 5);
          advance(pos, 5);
        } else {
          r0 = null;
      ...
      function parse_FiMtold() {
        var cacheKey = "FiMtold@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 4).toLowerCase() === "told") {
          r0 = input.substr(pos.offset, 4);
          advance(pos, 4);
        } else {
          r0 = null;
      ...
      function parse_FiMasked() {
        var cacheKey = "FiMasked@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 5).toLowerCase() === "asked") {
          r0 = input.substr(pos.offset, 5);
          advance(pos, 5);
        } else {
          r0 = null;
      ...
      function parse_FiMsaid() {
        var cacheKey = "FiMsaid@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMthen() {
        var cacheKey = "FiMthen@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 4).toLowerCase() === "then") {
          r0 = input.substr(pos.offset, 4);
          advance(pos, 4);
        } else {
          r0 = null;
      ...
      function parse_FiMgot() {
        var cacheKey = "FiMgot@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (input.substr(pos.offset, 3).toLowerCase() === "got") {
          r0 = input.substr(pos.offset, 3);
          advance(pos, 3);
        } else {
          r0 = null;
      ...
      function parse_FiMsalutation() {
        var cacheKey = "FiMsalutation@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 4).toLowerCase() === "dear") {
          r2 = input.substr(pos.offset, 4);
          advance(pos, 4);
        } else {
          r2 = null;
          if (reportFailures === 0) {
      ...
      function parse_FiMvalediction() {
        var cacheKey = "FiMvalediction@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 21).toLowerCase() === "your faithful student") {
          r2 = input.substr(pos.offset, 21);
          advance(pos, 21);
        } else {
          r2 = null;
          if (reportFailures === 0) {
            matchFailed("\"Your faithful student\"");
          }
        }
        if (r2 !== null) {
          r3 = parse_FiMcolon();
      ...
      function parse_FiMcolon() {
        var cacheKey = "FiMcolon@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMstatementEnd() {
        var cacheKey = "FiMstatementEnd@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMprogramQuotes() {
        var cacheKey = "FiMprogramQuotes@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMpossessive() {
        var cacheKey = "FiMpossessive@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 2).toLowerCase() === "'s") {
          r2 = input.substr(pos.offset, 2);
          advance(pos, 2);
        } else {
          r2 = null;
          if (reportFailures === 0) {
      ...
      function parse_FiMstartArgs() {
        var cacheKey = "FiMstartArgs@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        r1 = clone(pos);
        if (input.substr(pos.offset, 5).toLowerCase() === "given") {
          r0 = input.substr(pos.offset, 5);
          advance(pos, 5);
        } else {
          r0 = null;
      ...
      function parse_FiMsepArgs() {
        var cacheKey = "FiMsepArgs@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
