  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_FiMprogram() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, contents) {
      ...
      function parse_FiMstart() {
        var cacheKey = "FiMstart@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
      ...
      function parse_FiMblock() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ss) { return new CS.JavaScript("console.log('FiM')"); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_FiMidentifier() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, first, second) {
              // TODO: camel case?
